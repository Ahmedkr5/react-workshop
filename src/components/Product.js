...
export default class Product extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { product: props.prod, updated: 0 };
    ...
    componentDidMount() {
        console.log("I have finished rendering " + this.props.prod.name + " price: " + this.state.product.price);
    }
    componentDidUpdate() {
    ...
    addPrice(e) {
        ...
        this.setState((oldState) => ({
            product: { ...oldState.product, price: Number(oldState.product.price) + 1 },
